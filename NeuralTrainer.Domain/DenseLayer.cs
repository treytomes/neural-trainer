...
public class DenseLayer : ILayer
{
	...
	public DenseLayer(IActivationFunction activationFunction, IWeightInitializer weightInitializer)
		: this(1, activationFunction, weightInitializer)
	{
	}

	public DenseLayer(int inputSize, IActivationFunction activationFunction, IWeightInitializer weightInitializer)
		: this(inputSize, 1, activationFunction, weightInitializer)
	{
	}

	public DenseLayer(int inputSize, int outputSize, IActivationFunction activationFunction, IWeightInitializer weightInitializer)
	{
		InputSize = inputSize;
